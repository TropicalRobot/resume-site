    ...
    <section className="bg-cream relative pt-[80px]">
      ...
      <HorizontalScrollCarousel inputRange={["0%", "-90%"]}>
        <Testimonial
          ...
          image="/images/portfolio/ot/ot-favicon.png"
        ></Testimonial>
        <Testimonial
        ...
        <Testimonial
          ...
          image="/images/portfolio/sing-up/sing-up-icon.png"
        ></Testimonial>
        <Testimonial
          ...
          image="/images/portfolio/ski-solutions/ski-solutions-icon.png"
        ></Testimonial>
        <Testimonial
          ...
          image="/images/portfolio/wcva-logo.png"
        ></Testimonial>
        <Testimonial
          ...
          image="/images/portfolio/royal-holloway-icon.png"
        ></Testimonial>
